...
//        }
        ...
        {
            public Func<DataInfo, bool> isApplicableTo;
            public Action<DataInfo, MethodBuilder, string> buildSerialization;
            public Action<DataInfo, MethodBuilder, string> buildDeserialization;
            public bool write0IfNull = true;
        }
