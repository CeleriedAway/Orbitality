...
namespace ZergRush.CodeGen
{
	public static partial class CodeGen
	{
        ...
        {
            return ParentWithPredicate(t, p => p.HasAttribute<T>())?.GetCustomAttribute<T>();
        }
        ...
        public static string FileName(this Type t)
        {
	        ...
	        var hackName = "PortalHunter_";
	        if (str.StartsWith(hackName)) str = str.Remove(0, hackName.Length);
	        return str;
//            if (t.IsGenericType)
//            {
//                var name = t.Name;
