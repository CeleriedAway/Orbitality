...
namespace ZergRush.CodeGen
{
    public static partial class CodeGen
    {
        ...
        public static void RequestGen(Type t, GenTaskFlags flags, bool allowGenericDeclRegister = false)
        {
            ...
            if (t.IsPrimitive || t.IsEnum || t.IsGenericParameter || t == typeof(string) || t == typeof(byte[])) return;
...
//            }
        ...
        static object ExtractDefaultValue(MemberInfo member)
        {
            ...
            {
                return member.GetCustomAttribute<DefaultVal>().val;
            }
            return null;
        }
