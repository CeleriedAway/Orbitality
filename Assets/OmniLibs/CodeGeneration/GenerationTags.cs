...
{
    int modificationOwnerRefId { get; }
}
...
public interface ICustomSerialization : ISerializable
{
}

public interface ICustomHashing : IHashable
{
}

public interface ICustomUpdateFrom<T> : IUpdatableFrom<T>
{
}
...
public enum GenTaskFlags
{
    ...
    PooledDataPack = DefaultConstructor | Hash | CompareChech | JsonSerialization | Pooled | PooledUpdateFrom | PooledPolymorphicConstruction | PooledDeserialize,
    PooledNodePack = PooledDataPack | OwnershipHierarchy,
    PooledLivableNodePack = PooledNodePack | LifeSupport,
    
    ConfigData = Hash | Serialization | DefaultConstructor | PolymorphicConstruction | CollectConfigs,
...
public class GenRemoteCommands : GenTask
{
    ...
    public GenRemoteCommands(Type requestType, Type responseType, string commandTypeName, Type networkLayerType) : base (GenTaskFlags.CommandsGen)
    {
...
[AttributeUsage(AttributeTargets.Method)] public class CodeGenExtension : Attribute {}
