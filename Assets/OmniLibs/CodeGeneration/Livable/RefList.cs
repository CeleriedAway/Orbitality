...
{
    public sealed partial class RefList<T> : IList<T> where T : class, IDataNode, IReferencableFromDataRoot
    {
        ...
        public void UpdateFrom(RefList<T> other)
        {
            vals.Clear();
        ...
        {
            return vals.RemoveAll(i => i.id == item.Id) > 0;
        }
        ...
        public RefList(ObjectPool pool) { }
        public RefList() { }
    ...
    [GenTask(GenTaskFlags.CompareChech)]
