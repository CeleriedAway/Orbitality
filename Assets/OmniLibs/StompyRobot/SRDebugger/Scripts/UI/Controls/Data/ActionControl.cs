namespace SRDebugger.UI.Controls.Data
{
    ...
    public class ActionControl : OptionsControlBase
    {
        ...
        private void ButtonOnClick()
        {
            if (_method == null)
            {
                Debug.LogWarning("[SRDebugger.Options] No method set for actionConfig control", this);
                return;
            }
            ...
            {
                Debug.LogError("[SRDebugger] Exception thrown while executing actionConfig.");
