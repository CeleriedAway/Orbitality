...
namespace SRDebugger.UI.Tabs
{
    ...
    public class ConsoleTabController : SRMonoBehaviourEx
    {
        ...
        public void SendToEmail(string mailTo)
        {
            StringBuilder builder = new StringBuilder();
            foreach (var e in Service.Console.AllEntries)
            {
            ...
            SendMailToDev(mailTo, builder.ToString());
        }
        
        public void SendMailToDev(string content) => SendMailToDev("omnigames.develop@gmail.com", content);
        public void SendMailToDev(string targetMail, string content)
        {
            MailMessage mail = new MailMessage();
            var adress = "omnigames.develop@gmail.com";
            //var adress = "myinkmonster@gmail.com";
            mail.From = new MailAddress(adress);
            mail.To.Add(targetMail);

            SmtpClient smtpServer = new SmtpClient("smtp.gmail.com");
            smtpServer.Port = 587; //GIVE CORRECT PORT HERE
            mail.Subject = $"Logs {Application.platform} {ServerEngine.Time.now.ToString()}";
            mail.Body = content;
            smtpServer.Credentials = new System.Net.NetworkCredential(adress, "SunPaladin50") as ICredentialsByHost;
            ...
            Debug.Log("mail with logs sent to " + targetMail);
        }
    }
}
