...
namespace ZergRush.ReactiveUI
{
    ...
    public class LinearViewLoader<TView, TData> where TView : ReusableView
    {
        ...
        public void EnsureLoadedInterval(int indexStart, int indexFinish, List<TData> data)
        {
        ...
        public void ReloadAll(int indexStart, int indexFinish, List<TData> data)
        {
            UnloadAll();
            firstLoadedIndex = indexStart;
        ...
        public void PierceIndexIfLoaded(int index)
        {
            ...
            {
                UnloadView(index - firstLoadedIndex);
            }
        }
